...
object Town extends Room{
  ...
  val name = "pelican town square"
  val description = "Pelican town needs no introduction. You've been through the square countless times while accomplishing the tasks required by farm life"
